...
* 
*/
class SlumpModCharacterInfo_BARB_Agatha_Knight extends AOCCharacterInfo_Knight;
...
defaultproperties
{
	...
	GearData=(GearNameID=BarbAgathaKnight, GearStoreDescriptionID=Barb_Knight_Bundle_1, bVisibleInSelectorIfUnowned=true, bPartOfBundle=true, BundleNameID=Barb_Knight_Bundle_1)
