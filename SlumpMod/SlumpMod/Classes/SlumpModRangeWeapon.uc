...
simulated function ChangeProjectileType(class<AOCProjectile> Proj) {
	...
	if (class<SlumpModWeapon_Crossbow>(Class) != none && AOCOwner.PawnInfo.myTertiary == class'AOCWeapon_ExtraAmmo')
...
simulated state Active {
	simulated function BeginFire(byte FireModeNum) {
		...
		else if (bLoaded || (FireModeNum == Attack_Overhead && SlumpModWeapon_Crossbow(self) != none))
