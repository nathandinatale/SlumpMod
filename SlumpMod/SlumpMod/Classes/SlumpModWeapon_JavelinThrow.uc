...
class SlumpModWeapon_JavelinThrow extends AOCWeapon_JavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_JavelinThrow'
	...
	AlternativeMode=class'SlumpModWeapon_JavelinMelee'
