...
defaultproperties
{
	...
	/** Ownership info **/
	GearData=(GearNameID=BarbMasonArcher, GearStoreDescriptionID=Barb_Archer_Bundle_1, bVisibleInSelectorIfUnowned=true, bPartOfBundle=true, BundleNameID=Barb_Archer_Bundle_1)
