...
* 
*/
class SlumpModCharacterInfo_Mason_Knight_DLC1 extends AOCCharacterInfo_Mason_Knight;
...
defaultproperties
{
	...
	GearData=(GearNameID=MasonKnight_DLC1, GearStoreDescriptionID=Mason_Elite_Knight_Bundle_1, bPartOfBundle=true, BundleNameID=Mason_Elite_Knight_Bundle_1)
