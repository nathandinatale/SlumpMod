...
defaultproperties
{
	...
	GearData=(GearNameID=BarbAgathaVanguard, GearStoreDescriptionID=Barb_Vanguard_Bundle_1, bVisibleInSelectorIfUnowned=true, bPartOfBundle=true, BundleNameID=Barb_Vanguard_Bundle_1)
