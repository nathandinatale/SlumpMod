...
*/
class SlumpModWeapon_JavelinMelee extends AOCWeapon_JavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_Javelin'
	...
	bCanDodge=false
	AlternativeMode=class'SlumpModWeapon_JavelinThrow'
