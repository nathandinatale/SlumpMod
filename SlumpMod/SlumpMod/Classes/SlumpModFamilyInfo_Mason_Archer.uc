...
DefaultProperties
{
	...
	NewPrimaryWeapons(3)=(CWeapon=class'SlumpModWeapon_Crossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(4)=(CWeapon=class'SlumpModWeapon_LightCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(5)=(CWeapon=class'SlumpModWeapon_HeavyCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(6)=(CWeapon=class'SlumpModWeapon_JavelinMelee',CForceTertiary=(class'SlumpModWeapon_Buckler_Mason'))
	NewPrimaryWeapons(7)=(CWeapon=class'SlumpModWeapon_ShortSpearMelee',CForceTertiary=(class'SlumpModWeapon_Buckler_Mason'))
	NewPrimaryWeapons(8)=(CWeapon=class'SlumpModWeapon_HeavyJavelinMelee',CForceTertiary=(class'SlumpModWeapon_Buckler_Mason'))
	...
	NewTertiaryWeapons(2)=(CWeapon=class'SlumpModWeapon_Buckler_Mason',bEnabledDefault=false)
