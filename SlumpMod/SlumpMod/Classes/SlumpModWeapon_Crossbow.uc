...
* Crossbow.
*/
class SlumpModWeapon_Crossbow extends SlumpModRangeWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_Crossbow'
	...
	WeaponProjectiles(0)=class'SlumpModProj_SteelBolt'
