...
*/
class SlumpModWeapon_HeavyJavelinMelee extends AOCWeapon_HeavyJavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_HeavyJavelin'
	...
	bCanDodge=false
	AlternativeMode=class'SlumpModWeapon_HeavyJavelinThrow'
