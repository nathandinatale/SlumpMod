...
*/
class SlumpModWeapon_ShortSpearMelee extends AOCWeapon_ShortSpearMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_ShortSpear'
	...
	bCanDodge=false
	AlternativeMode=class'SlumpModWeapon_ShortSpearThrow'
