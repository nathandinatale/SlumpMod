...
*/
class SlumpModGFx_EscapeMain extends AOCGFx_ViewManager;
...
var SlumpModView_Frontend_Customization  NewCustomizationOpView;
...
{    
	...
	//LogAlwaysInternal("SlumpModGFx_EscapeMain::WidgetInitialized"@Widget);
    ...
    {           
		case ('Customization'):
			...
			{
				NewCustomizationOpView = SlumpModView_Frontend_Customization(Widget);
...
{
	//LogAlwaysInternal("SlumpModGFx_EscapeMain::LoadViewByName"@InputName);
	switch (InputName)
	{
	case "ConfigMain":
...
defaultproperties
{
	...
	WidgetBindings.Add((WidgetName="Customization",WidgetClass=class'SlumpModView_Frontend_Customization'))
